...
import com.denlavor.cep.domain.dto.district.DistritoResponseDTO;
...
//        return response.getBody();
    ...
    @GetMapping("{uf}")
    public Object consultaDistritoPorUf(@PathVariable("uf") String uf) throws JsonProcessingException {
...
//        return response.getBody();
        return locationService.loadDistrict(uf);
    }
}
